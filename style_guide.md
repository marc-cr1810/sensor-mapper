# Sensor Mapper C++ Code Style Guide

This guide describes the conventions and best practices for writing C++ code in the Sensor Mapper project, based on analysis of the project's `.cpp` and `.hpp` files.
...
- **Namespaces:** Use lowercase (e.g., `namespace sensor_mapper`).
...
Follow these conventions for all C++ code in Sensor Mapper to ensure consistency, readability, and maintainability.
