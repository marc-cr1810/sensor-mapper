...
struct antenna_pattern_t
{
  ...
  auto get_gain(float azimuth_deg, float elevation_deg = 0.0f, bool interpolate = true) const -> float
  {
    ...
    while (azimuth_deg < 0.0f)
      azimuth_deg += 360.0f;
    while (azimuth_deg >= 360.0f)
      azimuth_deg -= 360.0f;
...
public:
  ...
  static auto generate_sector(float beamwidth_deg, float fxb_ratio_db = 25.0f) -> std::shared_ptr<antenna_pattern_t>
  {
    auto pattern = std::make_shared<antenna_pattern_t>();
  ...
  static auto generate_patch(float h_beamwidth_deg, float v_beamwidth_deg, float gain_dbi = 6.0f) -> std::shared_ptr<antenna_pattern_t>
  {
    auto pattern = std::make_shared<antenna_pattern_t>();
    pattern->name = "Patch " + std::to_string(static_cast<int>(h_beamwidth_deg)) + "°x" + std::to_string(static_cast<int>(v_beamwidth_deg)) + "°";
  ...
  static auto generate_yagi(float beamwidth_deg, int num_elements = 5) -> std::shared_ptr<antenna_pattern_t>
  {
    auto pattern = std::make_shared<antenna_pattern_t>();
  ...
  static auto generate_horn(float beamwidth_deg, float gain_dbi = 15.0f) -> std::shared_ptr<antenna_pattern_t>
  {
    auto pattern = std::make_shared<antenna_pattern_t>();
  ...
  static auto generate_parabolic(float diameter_m, float frequency_mhz) -> std::shared_ptr<antenna_pattern_t>
  {
  ...
  static auto generate_bidirectional(float beamwidth_deg) -> std::shared_ptr<antenna_pattern_t>
  {
    auto pattern = std::make_shared<antenna_pattern_t>();
